...
export const navLinks = ['About', 'Services', 'Work', 'Testimonials',]
...
export const testimonials = [
  {
    ...
    name: "IMASHA & NIMESH",
    feedback:
      "Choosing [Photographer's Name] was the best decision we made! Their ability to find beauty in every little moment is unmatched. From candid shots to stunning portraits, the photos were simply perfect. Not only are they incredibly talented, but their friendly and patient personality made us feel so comfortable. We’ll cherish these memories forever. Thank you for your outstanding work!",
    image: "parallax1.jpg", // Example image path
  },
  {
    id: 2,
    name: "JANE & JOHN",
    feedback:
      "I can’t express how grateful we are to [Photographer's Name] for capturing the most important day of our lives. Each photo was filled with emotion, detail, and a magical touch that made us relive the day all over again. Their calm, professional approach put everyone at ease, and the results were nothing short of breathtaking. Truly an artist behind the lens! Highly recommend!",
    image: "parallax2.jpg",
  },
  {
    id: 3,
